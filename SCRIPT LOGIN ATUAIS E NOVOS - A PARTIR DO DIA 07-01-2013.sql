/*ADM*/
/*
-- Login Antigo: capta - db2010sql ate 06/01/2013
...
End 
--ALTER SERVER ROLE [sysadmin] ADD MEMBER [CAPTA] --SOMENTE SQL 2012
EXEC sp_addsrvrolemember 'capta', 'sysadmin'
Go
*/

-- Login Atual: capta - senha a partir de 07/01/2013 -> sql@2013adm
IF NOT EXISTS (SELECT * FROM master.dbo.syslogins WHERE name = N'capta')
Begin 
CREATE LOGIN [capta]
...
/*APLICAÇÃO*/
/*
-- Login Antigo: captarmtdb - UGhvZW5peEdyZWVuVmlsbGU===
...
*/
 ...
 -- Login Atual: captasisapl - Q2FwdGEjVkZQI2RvdG5ldEBA
