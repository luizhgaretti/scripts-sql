2)	CRIE UM TRIGGER CHAMADO TRG_OPERACAO QUE REGISTRE NA TABELA LOC_HIST_TRANSACAO_PED AS INFORMACOES OCORRIDAS NA TABELA DE PEDIDOS, INFORMANDO O NOME DO USUARIO, A DATA , A OPERAÇÃO REALIZADA  (I=INSERT, U=UPDATE, D=DELETE). ESSE TRIGGER É DE DECLARAÇÃO E SÓ DEVE OCORRER 1 ÚNICA VEZ A CADA TRANSAÇÃO.
