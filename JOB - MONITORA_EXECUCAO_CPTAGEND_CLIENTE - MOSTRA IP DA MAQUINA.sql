...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'passo1', 
		...
		@command=N'DECLARE @DBProfile VARCHAR(100)
				...
				set @string2 = '' Capta Processos parado no Servidor(SQL Instance): ''  + '' ''+ @servername + '' Hostname: '' + @HOSTNAME + '' '' + @IP + ''.'' + char(13) +  char(13) +
				...
				set @nr_processos = isnull(
					...
					begin
						...
						@recipients=''marcos.miyata@capta.com.br'',    
