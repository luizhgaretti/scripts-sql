...
/****** Object:  StoredProcedure [dbo].[SP_DBA_EmailSQLServerHealth]    Script Date: 11/12/2011 17:30:27 ******/
SET ANSI_NULLS ON
GO
...
--exec sp_serveroption [dl-100],'data access','true'
select *
into #jobs_status
from openquery([dl-100], 'set fmtonly off; exec msdb.dbo.sp_help_job')
