--- Envia resumo sobre o servidor.. mostrando status de BDs, Espaço livre em disco etc
...
GO
alter  PROCEDURE [dbo].[SP_DBA_EmailSQLServerHealth] 
(
...
--exec sp_serveroption [DGVZRGS1],'data access','true'
