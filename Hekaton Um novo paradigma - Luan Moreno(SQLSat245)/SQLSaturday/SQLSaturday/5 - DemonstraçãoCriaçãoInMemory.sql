...
--Criação Banco de Dados - In-Memory
...
ON PRIMARY
(
	NAME = 'InMemoryDBSQLSaturday',
	FILENAME = 'C:\BaseDados\mdf\InMemoryDBSQLSaturday.mdf',
	SIZE = 800MB
),
FILEGROUP InMemoryDB CONTAINS MEMORY_OPTIMIZED_DATA
(
	NAME = InMemoryDB1,
	FILENAME = 'C:\BaseDados\mdf\InMemoryDB1'
),
(
	NAME = InMemoryDB2,
	FILENAME = 'C:\BaseDados\mdf\InMemoryDB2'
)
LOG ON 
(
	NAME = InMemoryDBSQLSaturday_log,
	FILENAME = 'C:\BaseDados\ldf\InMemoryDBSQLSaturday_log.ldf',
	SIZE = 500MB
)
